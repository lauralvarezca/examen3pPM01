...
public class MainActivity extends AppCompatActivity {
        ...
        btneli.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(txtid.getText().toString().trim().isEmpty()){
                    ocultarTeclado();
                    Toast.makeText(MainActivity.this, "Digite el ID de la entrevista a eliminar", Toast.LENGTH_SHORT).show();
                }else{

                    int id = Integer.parseInt(txtid.getText().toString());

                    FirebaseDatabase db = FirebaseDatabase.getInstance();
                    DatabaseReference dbref = db.getReference(Entrevistas.class.getSimpleName());
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            for(DataSnapshot x : snapshot.getChildren()) {
                                if(aux.equalsIgnoreCase(x.child("id").getValue().toString())){
                                    ...
                                    a.setTitle("pregunta");
                                    a.setMessage("estas seguro de querer eliminar el registro");
                    ...
                    dbref.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if(res == false && res2 == false){
                                Entrevistas luc = new Entrevistas(id, nom);
                                dbref.push().setValue(luc);
                                ocultarTeclado();
                                Toast.makeText(MainActivity.this, "Entrevista registrada correctamente", Toast.LENGTH_SHORT).show();
                                txtid.setText("");
                                txtnom.setText("");
                            }
    ...
    private void listarEntrevistas(){
        ...
        ArrayList <Entrevistas> lisluc = new ArrayList<Entrevistas>();
        ArrayAdapter <Entrevistas> ada = new ArrayAdapter<Entrevistas>(MainActivity.this, android.R.layout.simple_list_item_1, lisluc);
        ...
        dbref.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                Entrevistas luc = snapshot.getValue(Entrevistas.class);
                lisluc.add(luc);
        ...
        lvDatos.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
               ...
               Entrevistas luc = lisluc.get(i);
                AlertDialog.Builder a = new AlertDialog.Builder(MainActivity.this);
                a.setCancelable(true);
                a.setTitle("Entrevista Seleccionada");
    ...
    private void botonBuscar() {
        ...
        btnbus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(txtid.getText().toString().trim().isEmpty()){
                    ocultarTeclado();
                    Toast.makeText(MainActivity.this, "Digite el ID de la entrevista a buscar", Toast.LENGTH_SHORT).show();
                }else{
